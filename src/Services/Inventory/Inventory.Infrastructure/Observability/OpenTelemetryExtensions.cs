...
{
    public static IServiceCollection AddInventoryTracing(this IServiceCollection services, IConfiguration configuration)
    {
    ...
    private static OpenTelemetryOptions BuildOptions(IConfiguration configuration)
    {
        ...
        {
            ServiceName = section["ServiceName"] ?? "Inventory",
