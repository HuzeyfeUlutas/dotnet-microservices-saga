...
{
    public static IServiceCollection AddCatalogTracing(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddOpenTelemetry()
            ...
            .WithMetrics(metrics => metrics
                .AddAspNetCoreInstrumentation()
                .AddHttpClientInstrumentation()
                .AddMeter(CatalogMetrics.MeterName)
    ...
    private static OpenTelemetryOptions BuildOptions(IConfiguration configuration)
    {
        ...
        {
            ServiceName = section["ServiceName"] ?? "Catalog",
