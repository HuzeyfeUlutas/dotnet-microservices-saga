...
{
    /// <inheritdoc />
    public partial class InitialOrderCheckout : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "order_checkout_saga_states",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_order_checkout_saga_states", x => x.CorrelationId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentFailedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VariantName = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_order_checkout_saga_states_OrderId",
                table: "order_checkout_saga_states",
                column: "OrderId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_order_checkout_saga_states_PaymentId",
                table: "order_checkout_saga_states",
                column: "PaymentId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_order_lines_OrderId_ProductId_Sku",
                table: "order_lines",
                columns: new[] { "OrderId", "ProductId", "Sku" });
